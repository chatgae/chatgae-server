package ktb.hackothon.chatgae.global.service;
...
import ktb.hackothon.chatgae.global.util.ImageUtil;
...
public class S3Service {
    ...
    public String createFileName(String fileName, Long popupId) {
        if (fileName.isEmpty()) {
            throw new ApiException(AppHttpStatus.MISSING_REQUEST_IMAGES);
        }
        // 파일 확장자 추출
    ...
    public String getFileExtension(String fileName) {
        ...
        if (!fileValidate.contains(idxFileName)) {
            ...
            throw new ApiException(AppHttpStatus.UNSUPPORTED_MEDIA_TYPE);
        }
